...
import { LogIn, Github, Mail, Database, ArrowLeft, Loader2 } from "lucide-react";
...
export default function LoginPage() {
    ...
    const handleSignIn = async (e: React.FormEvent) => {
        ...
        try {
            ...
            localStorage.setItem("agentiq_token", res.data.access_token);
            router.push("/");
        } catch (err: any) {
        ...
        <main className="min-h-screen gradient-bg flex items-center justify-center p-4">
            ...
            >
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-white/40 text-sm mt-2">Access your AGENTIQ AI workspace</p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleSignIn}>
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                            required
                            className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all"
                        />
                    </div>
                ...
                <div className="relative my-10 flex items-center justify-center">
                    ...
                    <span className="relative px-4 bg-[#0a0a0a] text-xs text-white/20 uppercase tracking-widest">Or continue with</span>
                </div>

                <div className="grid grid-cols-2 gap-4">
                    <button className="flex items-center justify-center space-x-2 py-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all">
                ...
                <p className="mt-8 text-center text-white/40 text-sm">
                    ...
                    <Link href="/register" className="text-blue-400 hover:underline">Register now</Link>
                </p>
            </motion.div>
        </main>
    );
